...
public class NetworkUtils  {
    ...
    public void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
             ...
             CommonData.getInstance().getContext().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS));
        } else {

             CommonData.getInstance().getContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS));
        }
    }
    ...
    public NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager)  CommonData.getInstance().getContext()
